...
A <- ggplot(counts2x, aes(x = Reference, y = Freq, fill = Subgenome, group = Reference)) +
  geom_bar(position = position_stack(), stat="identity", alpha = 0.7) +
  facet_grid(~ Chr, switch = "both") +
  scale_y_continuous(expand = c(0,0)) +
  scale_fill_manual(values = c("arabica" = "grey", "canephora" = "#993300", "eugenioides" = "#f5ad05")) +
  labs(y = "Number of SNPs", x = "Reference Alignment") +
  theme_classic() +
  theme(legend.position = "top", strip.background = element_blank(), strip.placement = "outside")

print(A)

ggsave("contagem_snps_por_cromossomo.png", plot = A, width = 10, height = 5, dpi = 400)
```
